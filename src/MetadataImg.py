...
path_directory = ros_Pack.get_path('ros_to_pix4d')+"_result/"
...
for name_file_img in names_files_img:
    ...
    data_gps_fila_tmp = data_gps[err_gps_stamp_min_pose]

    latitude_tmp = float(data_gps_fila_tmp["latitude"])
    longitude_tmp = float(data_gps_fila_tmp["longitude"])
    altitude_tmp = float(data_gps_fila_tmp["altitude"])
    ...
    data_odom_fila_tmp = data_odom[err_odom_stamp_min_pose]

    qx_tmp = float(data_odom_fila_tmp["qx"])
    qy_tmp = float(data_odom_fila_tmp["qy"])
    qz_tmp = float(data_odom_fila_tmp["qz"])
    qw_tmp = float(data_odom_fila_tmp["qw"])
